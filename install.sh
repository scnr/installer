...
- The Codename SCNR Licence Agreement;
...
1. Licences to Codename SCNR are available for purchase via the Licensor's website at https://portswigger.net/buy.
...
Codename SCNR Licence Agreement
...
1.1. In consideration of the payment by the Licensee of any agreed licence fee and the Licensee agreeing to abide by the terms of the Licence, the Licensor hereby grants to the Licensee a non-exclusive, non-transferable licence for the period (the "Licence Period") specified in the Licensee's order confirmation for the number of individual users specified therein to use the Software and the Documentation on the terms of the Licence.
...
1.3. Each installation of Codename SCNR on an individual computer needs to be activated before it will operate, including subsequent Licences commenced using auto-renewal. It is recognised that in the course of ordinary usage of the Software, individual users may need to install the product on more than one computer. The number of activations performed for each licence is monitored. The Licensor reserves the right to limit the number of activations allowed per licence, and to prevent further activations if this limit is exceeded.
...
Subject to the General Terms and Conditions, section 9.1, the Licensor's maximum aggregate liability under or in connection with this Licence, or any collateral contract, whether in contract, tort (including negligence) or otherwise, shall be limited to a sum equal to 125% (one hundred and twenty five per cent) of the average annual Licence Fee due under the Licence.
...
8.3. The Licensee acknowledges that the Software may not be free of bugs or errors, and agree that the existence of minor errors shall not constitute a breach of the Licence.
...
17.1. This Licence and any document expressly referred to in it represents the entire agreement between the parties in relation to the licensing of the Software, the Documentation and supersedes any prior agreement, understanding or arrangement between the parties, whether oral or in writing.
...
The Licence, its subject matter or its formation (including non-contractual disputes or claims) shall be governed by and construed in accordance with Greek law and submitted to the exclusive jurisdiction of the Greek courts.
EOF
